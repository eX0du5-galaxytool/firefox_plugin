			...
			for (var i = 0; i < nodes.length; i++) {
				if (nodes[i].nodeType == 1) {
					if (nodes[i].hasAttribute("id")
						...
						// important: Firefox requires childList instead of characterData
						// see https://forums.mozilla.org/addons/viewtopic.php?f=7&t=3180&start=25#p22875
						observer2.observe(doc.getElementById("div_traderAuctioneer").getElementsByClassName("numberOfBids")[0], { childList: true });
					}
				}
			}
		});
